...
if($_proses == "Simpan"){
    ...
    $sql = "INSERT INTO restock (restock_number,date,qty,harga_jual,price,
    supplier_id) VALUES (?,?,?,?,?,?)";
}else if($_proses == "Update"){
    // Jika Update, tambahkan ID ke array dan buat SQL UPDATE
    $ar_data[]=$_POST['id'];
    $sql = "UPDATE restock SET restock_number=?,date=?,qty=?,harga_jual=?,
...
// Redirect ke halaman daftar restock
