...
<form method="POST" action="proses_restock.php">
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Nomor restock</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="harga_beli" class="col-4 col-form-label">Tanggal</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">Id Supplier</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        value="<?php if(isset($row['supplier_id'])) echo $row['supplier_id']; ?>"
        type="text" class="form-control">
      </div>
    </div>
  </div>
