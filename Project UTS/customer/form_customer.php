...
<form method="POST" action="proses_customer.php">
  ...
  <div class="form-group row">
    <label for="stok" class="col-4 col-form-label">Nomor HP</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">Id Kartu</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="card_id" name="card_id" 
        value="<?php if(isset($row['card_id'])) echo $row['card_id']; ?>"
        type="text" class="form-control">
      </div>
    </div>
  </div>
