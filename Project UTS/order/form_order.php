...
<form method="POST" action="proses_order.php">
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Nomor Order</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Tanggal Order</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="harga_beli" class="col-4 col-form-label">Jumlah</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="stok" class="col-4 col-form-label">Total Harga</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">ID Customer</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">ID Produk</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
