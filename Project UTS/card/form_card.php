...
<form method="POST" action="proses_card.php">
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Code</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="stok" class="col-4 col-form-label">Discount</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
  ...
  <div class="form-group row">
    <label for="min_stok" class="col-4 col-form-label">Member fee</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
